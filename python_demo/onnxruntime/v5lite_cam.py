...
class yolov5_lite():
    ...
    def detect(self, srcimg):
        ...
        #print(outs.shape)
        print(f'inference:{cost_time}s, {1/cost_time}fps')
        row_ind = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='C:\Pro\pythonProject\Yolo-reim\hand\images\\002184_005.jpg', help="image path")
    #parser.add_argument('--modelpath', type=str, default='../../weights/best_5s-sim.onnx', help="onnx filepath")
    parser.add_argument('--modelpath', type=str, default='../../weights/best_5e-sim.onnx', help="onnx filepath")
    parser.add_argument('--classfile', type=str, default='hand.names', help="classname filepath")
