...
def main():
    ...
    parser.add_argument('--model-path', type=str, default=r"C:\Pro\pythonProject\Yolo-reim\yolo-fastest\YOLOv5-Lite/v5lite-e.pt", help='Path to the model')
    parser.add_argument('--img-path', type=str, default=r'C:\手势识别部分\yolo_hand部分\yolo_v3-master_hpx\datasets_TVCOCO_hand_train\anno\images\000103_007.jpg', help='input image path')
